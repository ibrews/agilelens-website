  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-24">
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-black mb-4">The Unofficial Team Page</h1>
        <p className="text-lg text-[var(--color-text-muted)] italic">The bios nobody asked for.</p>
        <p className="mt-4">
          <Link href="/team" className="text-[var(--color-accent)] hover:underline">Back to the real team page</Link>
        </p>
      </div>
