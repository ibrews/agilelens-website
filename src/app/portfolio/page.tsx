...
const projects: Project[] = [
  ...
  { name: 'Body of Mine', year: '2024', client: 'KOST / Meta Quest Store', desc: 'Award-winning full-body VR experience inviting users to inhabit the body of another gender. Agile Lens handled Meta Quest port and optimization.', category: 'Entertainment', awards: 'Producers Guild Innovation Award, BAFTA, SXSW' },
  { name: 'La Pasión XR', year: '2024', client: 'Gateway Chamber Orchestra', desc: 'Ephemeral, audio-reactive journey through Osvaldo Golijov\'s La Pasion según San Marcos with point cloud scans and volumetric highlights.', category: 'Entertainment', tech: 'Unreal Engine' },
  { name: 'A Christmas Carol VR', year: '2021–Present', desc: 'Live, real-time immersive adaptation of Dickens\' classic with facial/motion capture performers in virtual Victorian London. Annual R&D tradition.', category: 'Entertainment', tech: 'Unreal Engine, Facial/Motion Capture' },
  { name: 'The Orchard', year: '2022', client: 'Arlekin Players / Baryshnikov Arts Center', desc: 'Hybrid performance starring Mikhail Baryshnikov and Jessica Hecht. Created the virtual side of this Cherry Orchard adaptation.', category: 'Entertainment' },
  { name: 'Song of the Ambassadors', year: '2022', client: 'Alice Tully Hall @ Lincoln Center', desc: 'Previz for an experimental AI opera with lighting design by Refik Anadol.', category: 'Entertainment', tech: 'Unreal Engine' },
  { name: 'Dell Cybersecurity VR Challenge', year: '2023', client: 'Dell / Fair Worlds', desc: 'Narrative VR experience teaching cybersecurity tenets through a hacked booth scenario with motion capture and Metahumans.', category: 'Marketing', tech: 'Move.ai, Unreal Engine' },
  ...
  { name: 'Rice University Music & Performing Arts Center', year: '2014–2020', client: 'Allan Greenberg / Fisher Dachs', desc: 'VR used from concept to completion for a 600-seat opera theatre. Evaluated sightlines, aisles, and aesthetics.', category: 'Architecture', tech: 'Unity, Unreal, Revit' },
  { name: 'The Shed @ Hudson Yards', year: '2016–2019', client: 'Diller Scofidio + Renfro / Fisher Dachs', desc: 'Custom AR and VR for parametric design options and seat count optimization.', category: 'Architecture' },
  { name: 'Ghosted', year: '2019', desc: 'AR "dating simulator for ghosts" with volumetrically captured actors across a table.', category: 'Entertainment', awards: 'Most Innovative Immersive Experience (NBFF)', tech: 'Magic Leap, Depthkit, Unreal Engine' },
  ...
  { name: 'Statue of Liberty Museum', year: '2017', client: 'FXCollaborative', desc: 'Photoreal VR tour of Liberty Island with the new museum, optimized for 90 FPS.', category: 'Architecture' },
  ...
  { name: 'Intel Project Arena', year: '2018', client: 'Intel / The Glimpse Group / HOK', desc: 'Massive VR arena with thousands of AI fans showcasing Intel Core i9 processors.', category: 'Marketing', tech: 'Unreal Engine' },
  { name: 'Blueprint Immersive', year: '2024+', desc: 'Tools and previz software for architects — high-fidelity venue configuration.', category: 'R&D' },
  { name: 'Star Wars - Halcyon VR', year: '2024+', desc: 'Entertainment experience (in progress).', category: 'R&D' },
  { name: 'PerforMR', year: '2024+', desc: 'Performance research — live-actor animation pipeline.', category: 'R&D' },
